...
function defaultv () {
rm -f /etc/issue.net
wget -O /etc/issue.net https://raw.githubusercontent.com/${GitUser}/menu-theme/main/banner/bannersshDefault.conf && chmod +x /etc/issue.net
...
rm -f /etc/issue.net
wget -O /etc/issue.net https://raw.githubusercontent.com/${GitUser}/menu-theme/main/banner/bannerssh1.conf && chmod +x /etc/issue.net
...
rm -f /etc/issue.net
wget -O /etc/issue.net https://raw.githubusercontent.com/${GitUser}/menu-theme/main/banner/bannerssh2.conf && chmod +x /etc/issue.net
...
rm -f /etc/issue.net
wget -O /etc/issue.net https://raw.githubusercontent.com/${GitUser}/menu-theme/main/banner/bannerssh3.conf && chmod +x /etc/issue.net
...
rm -f /etc/issue.net
wget -O /etc/issue.net https://raw.githubusercontent.com/${GitUser}/menu-theme/main/banner/bannerssh4.conf && chmod +x /etc/issue.net
